...
```
cd existing_repo
git remote add origin https://igm-git.igm.rwth-aachen.de/Riswadkar/hiwi_robotic_hands.git
git branch -M main
...
- [ ] [Set up project integrations](https://igm-git.igm.rwth-aachen.de/Riswadkar/hiwi_robotic_hands/-/settings/integrations)
